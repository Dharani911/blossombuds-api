...
public interface CouponRedemptionRepository extends JpaRepository<CouponRedemption, Long> {
    ...
    CouponRedemption findByOrder_IdAndActiveTrue(Long orderId);
    ...
    long countByCoupon_IdAndActiveTrue(Long couponId);
    long countByCoupon_IdAndCustomerIdAndActiveTrue(Long couponId, Long customerId);
